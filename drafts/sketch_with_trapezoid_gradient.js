...
function computeGradient(baseColor) {
    ...
    let c2 = color(red(c1) + 50, green(c1) + 50, blue(c1) + 50);  // Lighter shade of base color
    return [c1, c2];
}
...
fill(lerpColor(gradientColors[0], gradientColors[1], 0.1));
    ...
    vertex(this.x + this.w - this.trapezoidReduction, this.y - this.h, this.z);
    vertex(this.x + this.trapezoidReduction, this.y - this.h, this.z);
